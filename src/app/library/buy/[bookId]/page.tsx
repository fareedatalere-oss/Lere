...
export default function BuyBookPage() {
  ...
  const handlePurchase = async (e: React.FormEvent) => {
    ...
    if (user.balance < book.price) {
      toast({ variant: "destructive", title: "Insufficient Funds", description: "Please fund your wallet to buy this book." });
      return;
    }
    ...
    try {
      ...
      await updateDoc(userRef, { balance: increment(-book.price) });
      ...
      toast({ title: "Purchase Successful", description: `You now own ${book.title}.` });
      router.push("/library");
    } catch (err) {
